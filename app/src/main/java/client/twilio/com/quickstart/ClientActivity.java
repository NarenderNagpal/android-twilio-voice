...
public class ClientActivity extends AppCompatActivity implements DeviceListener, ConnectionListener {
     ...
     */
    private static final String TOKEN_SERVICE_URL = "your url for token from twilio";
...
*/
       // Log.e(TAG,"Number  "+contact+  clientDevice);
    ...
    private DialogInterface.OnClickListener callClickListener() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // Create an outgoing connection
                connect(contact.getText().toString(), true);
                alertDialog.dismiss();
            }
        };
    }
